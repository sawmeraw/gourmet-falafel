...
export default function LocationBanner() {
  return (
    <section className="bg-white py-12 shadow-md border-t border-gray-100">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 w-full md:w-3/5">
            <div className="flex items-center">
              <div className="mr-5">
              <IoLocationSharp  size={40} className='text-amber-600'/>
              </div>
              <div>
                <h3 className="text-xl font-medium text-gray-700">We are located at</h3>
                <p className="text-3xl font-bold text-amber-600">Adelaide Central Market</p>
